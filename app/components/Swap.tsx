...
export function Swap({ publicKey, tokenBalances, onSwapSuccess }: {
    publicKey: string;
    tokenBalances: {
        totalBalance: number,
    ...
    useEffect(() => {
        ...
        axios.get(`https://api.jup.ag/swap/v1/quote?inputMint=${baseAsset.mint}&outputMint=${quoteAsset.mint}&amount=${Number(baseAmount) * (10 ** baseAsset.decimals)}&slippageBps=50`, {
            headers: {
    ...
    return <div className="p-12 bg-slate-50">
        ...
        <div className="flex justify-center">
            ...
            }} className="cursor-pointer rounded-full w-10 h-10 border absolute mt-5 bg-white flex justify-center pt-2">
                <SwapIcon />
            </div>
        </div>
